...
for year in ${years[@]}
    ...
    if [ ${mconly} = "on" ]
        ...
        if [ $1 = "UL2016" ]
            ...
            cp variations/output_nominal_newnt_${year}_UL2016.root variations/output_CRFit_${year}.root
        elif [ $1 = "UL20178" ]
            then
            # rm variations/output_CRFit_${year}.root
            ...
            # ./run/make_jer_symm.exe ${year} variations/output_CRFit_${year}.root
            cp variations/output_nominal_newnt_${year}_UL20178.root variations/output_CRFit_${year}.root
        else
            # rm variations/output_CRFit_${year}.root
