...
int main(int argc, char* argv[])
{
    ...
    TString bin[nbins] = {
        ...
        "0-lepton,HT>1500,4#leq N_{jets}#leq5,300<MJ<500",
    ...
    TString binLatex[nbins] = {
        ...
        "N_{leps}=0,H_{T}>1500~\\textrm{GeV},4\\leq N_{jets}\\leq5,300<M_{J}<500~\\textrm{GeV}",
        ...
        "N_{leps}=0,H_{T}>1500~\\textrm{GeV},N_{jets}\\geq10,500<M_{J}<800~\\textrm{GeV}",
        ...
        "N_{leps}=0,H_{T}>1500~\\textrm{GeV},N_{jets}\\geq10,800<M_{J}<1000~\\textrm{GeV}",
        ...
        "N_{leps}=0,H_{T}>1500~\\textrm{GeV},8\\leq N_{jets}\\leq9,500<M_{J}<800~\\textrm{GeV}",
        ...
        "N_{leps}=0,H_{T}>1500~\\textrm{GeV},N_{jets}\\geq10,M_{J}>1000~\\textrm{GeV}",
        ...
        float dataovermc, bool doNorm, bool printErr)
{
    ...
    {
    cout << nbbin << " & "
        << "$" << formatYield(qcd) << " \\pm " << formatYield(qcd_err) << "$ & "
        << "$" << formatYield(ttbar) << " \\pm " << formatYield(ttbar_err) << "$ & "
        << "$" << formatYield(wjets) << " \\pm " << formatYield(wjets_err) << "$ & "
        << "$" << formatYield(other) << " \\pm " << formatYield(other_err) << "$ & "
        << "$" << formatYield(qcd+ttbar+wjets+other) << " \\pm " << formatYield(tot_err) << "$ & "
        << Form("$%.0f$",data) << " & "
        << "$" << formatYield(sig) << "$ \\\\ " << endl;
    }
    else 
    { 
    cout << nbbin << " & "
        ...
        << "$" << formatYield(wjets) << "$ & "
        << "$" << formatYield(other) << "$ & "
        << "$" << formatYield(qcd+ttbar+wjets+other) << "$ & "
        << Form("$%.0f$",data) << " & "
        << "$" << formatYield(sig) << "$ \\\\ " << endl;
    }
}
